...
Dado el mueble "cama" con código 444 que no está registrado en el sistema.
...
Entonces el sistema redirige al usuario al pago de reserva con tarjeta de crédito, espera respuesta, lleva a cabo la reserva, actualiza el stock disponible de muebles e informa "Reserva exitosa.

Escenario 2: Reserva fallida por cantidad de muebles menor a la permitida.
Dado los muebles "silla" y "mesa" que tienen stock, la cantidad de muebles 2 es menor a 3 y las condiciones de pago son las adecuadas.
Cuando se ingresa la reserva con fecha 4/7/2026, lugar del evento "La Plata", cantidad de días 1, nombre del mobiliario "Facundo" y cantidad 2 de muebles, y se presiona "Aceptar".
Entonces el sistema informa "La cantidad de muebles es inválida".

Escenario 3: Reserva fallida por falta de stock en muebles.
Dados los muebles "silla", "cama", "mesa" y "escritorio", no hay stock de muebles y las condiciones de pago son las adecuadas.
...
Cuando se ingresa el número de tarjeta "678" y se presiona "Pagar"
